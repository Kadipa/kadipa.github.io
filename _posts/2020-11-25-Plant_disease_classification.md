...
![Plant Dataset](https://github.com/Kadipa/kadipa.github.io/blob/master/images/2.png)
...
![Plant Dataset](https://github.com/Kadipa/kadipa.github.io/blob/master/images/3.png)

(၄) Model evaluation

Model train လို့ပြီးရင် model ကို evaluation လုပ်ပြီး Train F1 score နဲ့ Test F1 scoreထုတ်ကြည့်ပါမယ်။

![Plant Dataset](https://github.com/Kadipa/kadipa.github.io/blob/master/images/4.png)

Model train နေတုန်း overfit ဖြစ် မဖြစ် သိစေရန် modelရဲ့ loss နဲ့ accuray ကိုလည်း plot ထုတ်ကြည့်ပါမယ်။

![Plant Dataset](https://github.com/Kadipa/kadipa.github.io/blob/master/images/5.png)

Classတခုချင်းစီအတွက် ဘယ်လောက် မှန်မှန် predict လုပ်နိုင်လဲ သိချင်လို့ Confusion Matrix လည်း ထုတ်ကြည့်ပါမယ်။

![Plant Dataset](https://github.com/Kadipa/kadipa.github.io/blob/master/images/6.png)
